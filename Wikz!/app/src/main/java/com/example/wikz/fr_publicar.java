...
public class fr_publicar extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        inflater.inflate(R.layout.fr_publicar, container, false);
        ...
        api.getPublicaciones(fr_publicar.this.getActivity(), (success, pubs) -> {
            if(success){
                ...
                fr_publicar.this.getActivity().runOnUiThread(() -> {
