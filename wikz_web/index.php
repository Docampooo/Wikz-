...
<body class="dark-theme">
    ...
    <script>
        // Recogemos los datos que PHP guardó en la sesión
        ...
        //Pasamos esos datos a JavaScript de forma segura
        ...
        if (usuarioDesdePHP) {
            ...
            //actualizamos el localStorage si no existe una sesión previa 
        ...
        //Crear la variable global que usará app.js
    ...
    <script>
        //Al cargar la página por completo, mostramos la sección Explorar
        window.onload = () => {
